  ...
  return (
    <div>
      <div className={styles.header} style={{ justifyContent: 'flex-start', gap: '1rem' }}>
        <Link href="/staff/products" style={{ display: 'flex', alignItems: 'center', color: '#666' }}>
          <ArrowLeft size={20} />
        </Link>
      ...
      <div className={styles.card} style={{ maxWidth: '800px' }}>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{ paddingTop: '1rem', borderTop: '1px solid #eee', display: 'flex', justifyContent: 'flex-end', gap: '1rem' }}>
            <Link href="/staff/products" className="btn" style={{ border: '1px solid #ddd', color: '#666', textDecoration: 'none' }}>
              Cancel
            </Link>
            <button 
              type="submit" 
