  ...
  return (
    <div>
      <div className={styles.header}>
        ...
        <Link href="/staff/products/new" className="btn" style={{ 
                  ...
                  <tr key={product.id} style={{ borderBottom: '1px solid #eee' }}>
                    ...
                    <td style={{ padding: '1rem', textAlign: 'right' }}>
                      <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                        <Link href={`/staff/products/${product.id}`} style={{ padding: '0.5rem', color: '#2563eb', backgroundColor: '#eff6ff', borderRadius: '4px' }}>
                          <Edit size={18} />
                        </Link>
                        <button 
